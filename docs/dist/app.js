...
var UICommonEvent_1 = __webpack_require__(27);
exports.UICommonEvent = UICommonEvent_1.UICommonEvent;
var UIMouseEvent_1 = __webpack_require__(28);
...
var Collection = (function (_super) {
    ...
    function Collection(handler, appInstance) {
        ...
        _this.items = [];
        _this._defaultStoryboard = appInstance;
        return _this;
    }
...
Object.defineProperty(exports, "__esModule", { value: true });
var ui_1 = __webpack_require__(18);
var events_1 = __webpack_require__(0);
...
var ApplicationStoryboard = (function (_super) {
    ...
    ApplicationStoryboard.prototype.onCreate = function () {
        var _this = this;
        ...
        var label = new Label_1.Label(this);
        label.left = 320;
        label.top = 128;
        ...
        var rect = new Rectangle_1.Rectangle(this);
        rect.height = 32;
        rect.width = 32;
        rect.left = 0;
        rect.top = 0;
        ...
        var button = new Button_1.Button(this);
        button.left = 128;
        button.top = 128;
        ...
        this.interval = setInterval(function () {
            label.text = "Redraw requests: " + _this.redrawTimes + "\nFPS: " + _this.fps;
            _this.fps = 0;
            _this.redrawTimes = 0;
        }, 1000);
        window.requestAnimationFrame(function () { return _this.fpsCount; });
    };
    ApplicationStoryboard.prototype.onDestroy = function () {
        _super.prototype.onDestroy.call(this);
        clearInterval(this.interval);
    };
    ApplicationStoryboard.prototype.fpsCount = function () {
        var _this = this;
        this.fps++;
        window.requestAnimationFrame(function () { return _this.fpsCount; });
    };
    return ApplicationStoryboard;
}(Storyboard_1.Storyboard));
exports.ApplicationStoryboard = ApplicationStoryboard;
    ...
    CanvasMouseEventBroadcaster.prototype._initHandlers = function () {
        ...
        this.eventHandlers
            ...
            if (helpers_1.$null(old)) {
                this.mapper.currentMouseElement = element;
                tEvent = new events_1.UIMouseEvent(element, event);
                element.emit('mouseover', tEvent);
            }
            else {
                if (old.id !== element.id) {
                    tEvent = new events_1.UIMouseEvent(old, event);
...
var MTRenderError = (function (_super) {
    ...
    return MTRenderError;
}(MentholException_1.MentholException));
exports.MTRenderError = MTRenderError;
...
var MTInvalidOperationException = (function (_super) {
    ...
    return MTInvalidOperationException;
}(MentholException_1.MentholException));
exports.MTInvalidOperationException = MTInvalidOperationException;
...
Object.defineProperty(exports, "__esModule", { value: true });
var Menthol = (function () {
    function Menthol() {
    }
    Menthol.bootstrapView = function (canvas, boardClass) {
